...
class BlogPage extends BasePage {
  constructor(page) {
    ...
    this.firstArticleTitle = page.locator('article h3').nth(0);
    this.secondArticleTitle = page.locator('article h3').nth(1);
    this.thirdArticleTitle = page.locator('article h3').nth(2);
